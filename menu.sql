...
(2, 'Sajtburger', 'frissen sült húspogácsa sajttal, friss saláta, paradicsom és vöröshagyma a frissen sütött zsemlében, különleges szósszal tálalva', 'Burger', 2000, 'Sajtburger.jpg'),
...
(5, 
'Tres Burger',
 'Ha nagy éhséggel küzd, akkor a tripla burgerünk a tökéletes választás! Friss, ropogós zsemlében, három szaftos húspogácsával és gazdag ízekkel.',
  'Burger', 5000, 'triplaburger.png'),
(6, 
'Tojásos burger', 
'Kóstolja meg a tojásos burgerünk ínycsiklandó ízeit! Szaftos húspogácsa, friss zöldségek és egy finom tojás, mindez egy friss zsemlében tálalva.', 
'Burger', 2500, 'tojasosburger.png'),
...
(9, 'Bacon Burger', 'Kóstolja meg a bacon burgerünk pikáns és szaftos ízeit, amelyben friss zöldségek, szaftos húspogácsa és ropogós bacon csíkok találkoznak egy friss zsemlében..', 'Burger', 3900, 'baconburger.jpg'),
(10, 'Avocado Burger', 'Classic hamburger with sliced avocado, lettuce, tomato, and garlic mayo.', 'Burger', 5400, 'avokádós.jpg');
